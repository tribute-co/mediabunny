...
`,`
`).replaceAll("\r",`
`),xt.lastIndex=0;let t;if(!this.preambleText){if(!Xa.test(e))throw new Error("WebVTT preamble incorrect.");t=xt.exec(e);let r=e.slice(0,t?.index??e.length).trimEnd();if(!r)throw new Error("No WebVTT preamble provided.");this.preambleText=r,t&&(e=e.slice(t.index),xt.lastIndex=0)}for(;t=xt.exec(e);){let r=e.slice(0,t.index),a=t[1],n=t.index+t[0].length,s=e.indexOf(`
